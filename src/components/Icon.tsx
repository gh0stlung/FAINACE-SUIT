...
export const Icon = React.memo(({ name, size=24, className }: any) => {
  const p: any = { width:size, height:size, viewBox:"0 0 24 24", fill:"none", stroke:"currentColor", strokeWidth:"2", strokeLinecap:"round", strokeLinejoin:"round", className };
  switch (name) {
    ...
    case 'sparkles': return <svg {...p}><path d="M12 3l2.5 5.5L20 11l-5.5 2.5L12 19l-2.5-5.5L4 11l5.5-2.5L12 3z"/><path d="M19 19l1 2 2-1-2-1-1-2z"/></svg>;
    ...
    case 'more': return <svg {...p}><circle cx="12" cy="12" r="1"/><circle cx="12" cy="5" r="1"/><circle cx="12" cy="19" r="1"/></svg>;
    default: return null;
  }
});
